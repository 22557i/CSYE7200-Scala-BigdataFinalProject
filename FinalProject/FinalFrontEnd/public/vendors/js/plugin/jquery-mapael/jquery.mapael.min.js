...
!function (a) {
    ...
    return e.prototype = {
        ...
        init: function () {
            ...
            if (c.$tooltip = a("<div>").addClass(c.options.map.tooltip.cssClass).css("display", "none"), c.$map.empty().append(c.$tooltip), a.mapael && a.mapael.maps && a.mapael.maps[c.options.map.name]) c.mapConf = a.mapael.maps[c.options.map.name]; else {
            ...
            c.$container.addClass("mapael"), c.options.map.tooltip.css && c.$tooltip.css(c.options.map.tooltip.css), c.paper.setViewBox(0, 0, c.mapConf.width, c.mapConf.height, !1), c.options.map.width ? (c.paper.setSize(c.options.map.width, c.mapConf.height * (c.options.map.width / c.mapConf.width)), c.createLegends("plot", c.plots, c.options.map.width / c.mapConf.width)) : c.handleMapResizing(), a.each(c.mapConf.elems, function (a) {
                ...
                c.areas[a] = {mapElem: c.paper.path(c.mapConf.elems[a]).attr(b.attrs)}
        ...
        extendDefaultOptions: function (b) {
            return b = a.extend(!0, {}, e.prototype.defaultOptions, b), a.each(["area", "plot"], function (c, d) {
                if (a.isArray(b.legend[d])) for (var f = 0; f < b.legend[d].length; ++f) b.legend[d][f] = a.extend(!0, {}, e.prototype.legendDefaultOptions[d], b.legend[d][f]); else b.legend[d] = a.extend(!0, {}, e.prototype.legendDefaultOptions[d], b.legend[d])
            }), b
        },
        ...
        initZoom: function (b, c, e) {
            ...
            a.extend(f.zoomData, {zoomLevel: 0, panX: 0, panY: 0}), a.each(e.buttons, function (b, c) {
                ...
                var b = a.deltaY > 0 ? 1 : -1, c = f.mapPagePositionToXY(a.pageX, a.pageY);
                ...
                var k = f.zoomData.zoomLevel, l = 0, m = 0;
        ...
        onZoomEvent: function (b, c) {
            var e = this, f = e.zoomData.zoomLevel, g = 0, h = 0,
                i = 1 + e.zoomData.zoomLevel * e.options.map.zoom.step, j = 0,
                k = c.animDuration !== d ? c.animDuration : e.options.map.zoom.animDuration, l = 0, m = 0, n = {};
        ...
        onUpdateEvent: function (b, c) {
            var e = this;
            if ("object" == typeof c) {
                var f = 0, g = c.animDuration ? c.animDuration : 0, h = function (a) {
                ...
                })), "object" == typeof c.deletePlotKeys) for (; f < c.deletePlotKeys.length; f++) e.plots[c.deletePlotKeys[f]] !== d && (h(e.plots[c.deletePlotKeys[f]]), delete e.plots[c.deletePlotKeys[f]]); else "all" === c.deletePlotKeys && (a.each(e.plots, function (a, b) {
                    h(b)
                }), e.plots = {});
                if ("object" == typeof c.deleteLinkKeys) for (f = 0; f < c.deleteLinkKeys.length; f++) e.links[c.deleteLinkKeys[f]] !== d && (h(e.links[c.deleteLinkKeys[f]]), delete e.links[c.deleteLinkKeys[f]]); else "all" === c.deleteLinkKeys && (a.each(e.links, function (a, b) {
                    h(b)
                }), e.links = {});
        ...
        drawLink: function (a, b, c, d, e, f) {
            var g = this, h = {}, i = (b + d) / 2, j = (c + e) / 2, k = -1 / ((e - c) / (d - b)), l = j - k * i,
                m = Math.sqrt((d - b) * (d - b) + (e - c) * (e - c)), n = 1 + k * k, o = -2 * i + 2 * k * l - 2 * k * j,
                p = i * i + l * l - l * j - j * l + j * j - f.factor * m * (f.factor * m), q = o * o - 4 * n * p, r = 0,
                s = 0;
        ...
        drawLegend: function (c, e, f, g, h) {
            var i = this, j = {}, k = {}, l = 0, m = 0, n = null, o = {}, p = {}, q = {}, r = 0, s = 0, t = 0, u = 0,
                v = [], w = 0;
            for (j = a("." + c.cssClass, i.$container), void 0 === i.createdLegends[c.cssClass] && (i.createdLegends[c.cssClass] = {
                ...
                "data-type": e,
                "data-index": h
            }), m = l = 0, c.title && "" !== c.title && (n = k.text(c.marginLeftTitle, 0, c.title).attr(c.titleAttrs), n.attr({y: .5 * n.getBBox().height}), l = c.marginLeftTitle + n.getBBox().width, m += c.marginBottomTitle + n.getBBox().height), r = 0, w = c.slices.length; r < w; ++r) {
                var x = 0;
            ...
            for ("horizontal" == c.mode && (l = c.marginLeft), r = 0, w = v.length; r < w; ++r) if (v[r].display === d || v[r].display === !0) {
                ...
                a(o.node).attr({
                    ...
                    "data-index": r,
                    "data-hidden": 0
                }), c.hideElemsOnClick.enabled && (q.attr({cursor: "pointer"}), o.attr({cursor: "pointer"}), i.setHoverOptions(o, v[r].attrs, v[r].attrs), i.setHoverOptions(q, c.labelAttrs, c.labelAttrsHover), i.setHover(o, q), i.handleClickOnLegendElem(c, c.slices[r], q, o, f, h))
            }
            "SVG" != b.type && c.VMLWidth && (l = c.VMLWidth), k.setSize(l, m)
        },
        handleClickOnLegendElem: function (b, c, e, f, g, h) {
            var i = this, j = function (j, k, l) {
                var m = 0, n = a(e.node).attr("data-hidden"),
                    o = "0" === n ? {"data-hidden": "1"} : {"data-hidden": "0"};
                l === d && (l = b.hideElemsOnClick.animDuration), "0" === n ? l > 0 ? e.animate({opacity: .5}, l) : e.attr({opacity: .5}) : l > 0 ? e.animate({opacity: 1}, l) : e.attr({opacity: 1}), a.each(g, function (e) {
        ...
        createLegends: function (b, c, d) {
            var e = this, f = e.options.legend[b];
        ...
        setHover: function (b, c) {
            var d = this, e = {}, f = {}, g = 0, h = 0, i = function () {
        ...
        getElemOptions: function (b, c, e) {
            var f = this, g = a.extend(!0, {}, b, c);
            if (g.value !== d) if (a.isArray(e)) for (var h = 0, i = e.length; h < i; ++h) g = a.extend(!0, {}, g, f.getLegendSlice(g.value[h], e[h])); else g = a.extend(!0, {}, g, f.getLegendSlice(g.value, e));
            return g
        },
        getTextPosition: function (a, b, c) {
            ...
            switch ("number" == typeof c && (c = "bottom" === b || "top" === b ? {
                x: 0,
                y: c
            } : "right" === b || "left" === b ? {x: c, y: 0} : {x: 0, y: 0}), b) {
                case"bottom":
        ...
        getLegendSlice: function (a, b) {
            for (var c = 0, e = b.slices.length; c < e; ++c) if (b.slices[c].sliceValue !== d && a == b.slices[c].sliceValue || b.slices[c].sliceValue === d && (b.slices[c].min === d || a >= b.slices[c].min) && (b.slices[c].max === d || a <= b.slices[c].max)) return b.slices[c];
            return {}
        },
        animateViewBox: function (a, c, d, e, f, g) {
            var h, i = this, j = i.paper._viewBox ? i.paper._viewBox[0] : 0, k = a - j,
                l = i.paper._viewBox ? i.paper._viewBox[1] : 0, m = c - l,
                n = i.paper._viewBox ? i.paper._viewBox[2] : i.paper.width, o = d - n,
                p = i.paper._viewBox ? i.paper._viewBox[3] : i.paper.height, q = e - p, r = f / 25, s = 0;
        ...
        isRaphaelBBoxBugPresent: function () {
            var a = this, b = a.paper.text(-50, -50, "TEST"), c = b.getBBox();
