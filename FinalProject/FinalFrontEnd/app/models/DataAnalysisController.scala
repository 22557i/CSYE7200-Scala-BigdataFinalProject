...
case class DataAnalysisController()
object DataAnalysisController {
  val spark: SparkSession = SparkSession.builder().master("local").getOrCreate()
  val PATH:String = "./public/dataSets/dataSet.csv"
  val OLD_PATH:String = "./public/dataSets/AB_NYC_2019.csv"

  def loadBasicData(file:String ):DataFrame = {
